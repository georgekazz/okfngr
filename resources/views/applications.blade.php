...
<body>
    ...
    <section class="apps-hero">
        ...
        <div class="hero-content">
            <div class="hero-badge">
                ...
                <span>{{ __('applications.hero.badge') }}</span>
            </div>

            <h1>{{ __('applications.hero.title') }}</h1>
            <p class="hero-lead">{{ __('applications.hero.subtitle') }}</p>
        </div>
    </section>
    ...
    <section class="apps-section">
        <div class="content-container">
            ...
            <div class="apps-grid">
                @foreach(__('applications.apps') as $app)
                    <article class="app-card">
                        @if(isset($app['image']))
                            <div class="app-image">
                                <img src="{{ asset('img/applications/' . $app['image']) }}" alt="{{ $app['title'] }}"
