...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/userPanel/dayoff.css') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('user.day-offs.edit', ['locale' => app()->getLocale(), 'id' => $dayOff->id]) }}"
                                                class="btn-icon btn-edit" title="Επεξεργασία">
                                            ...
                                            <form
                                                action="{{ route('user.day-offs.destroy', ['locale' => app()->getLocale(), 'id' => $dayOff->id]) }}"
                                                method="POST" style="display: inline;"
                                                onsubmit="return confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την άδεια;')">
                                                @csrf
                                                @method('DELETE')
