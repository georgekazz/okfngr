    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            ...
            <div class="form-container">
                <form action="{{ route('user.day-offs.update', ['locale' => app()->getLocale(), 'dayOff' => $dayOff->id]) }}" method="POST" id="dayOffForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-actions">
                        <a href="{{ route('user.day-offs.index', ['locale' => app()->getLocale()]) }}" class="btn-cancel">
                            Ακύρωση
                        </a>
