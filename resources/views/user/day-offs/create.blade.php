...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/userPanel/dayoff-create.css') }}">
    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            ...
            <div class="form-container">
                <form action="{{ route('user.day-offs.store', ['locale' => app()->getLocale()]) }}" method="POST"
                    id="dayOffForm">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="end_date" name="end_date"
                                ...
                                value="{{ old('end_date', optional($dayOff->end_date)->format('Y-m-d')) }}" required>
                            @error('end_date')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
