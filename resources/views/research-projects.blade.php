                ...
                @foreach(__('projects.list') as $project)
                    <div class="project-card">
                        <div class="project-image">
                            <img src="{{ asset('img/researchProjects/' . $project['image']) }}"
                                alt="{{ $project['title'] }}"
                                onerror="this.src='{{ asset('img/projects/placeholder.jpg') }}'">
