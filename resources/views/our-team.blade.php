    ...
    <header>
        <div class="header-container">
            ...
            <nav>
                ...
                <div class="nav-item has-dropdown">
                    <a href="{{ route('our-team', ['locale' => app()->getLocale()]) }}" class="nav-link active">{{ __('home.nav.who_we_are') }} <span class="dropdown-arrow">▼</span></a>
                    <div class="dropdown-menu">
                        <a href="{{ route('our-team', ['locale' => app()->getLocale()]) }}" class="dropdown-item active">{{ __('home.nav.team') }}</a>
