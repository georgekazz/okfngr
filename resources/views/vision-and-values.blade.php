        ...
        <div class="header-container">
            ...
            <div class="nav-actions">
                ...
                <div class="lang-switcher">
                    <a href="{{ route('vision-and-values', ['locale' => 'en']) }}" class="lang-link {{ app()->getLocale() == 'en' ? 'active' : '' }}">
                        <img src="{{ asset('img/uk-flag.png') }}" alt="English" class="flag-icon">
                        EN
                    </a>
                    <a href="{{ route('vision-and-values', ['locale' => 'el']) }}" class="lang-link {{ app()->getLocale() == 'el' ? 'active' : '' }}">
