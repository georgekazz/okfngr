    ...
    <div class="dashboard-layout">
        ...
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin.users', ['locale' => app()->getLocale()]) }}" class="nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M14 17.5V15.8333C14 14.9493 13.6488 14.1014 13.0237 13.4763C12.3986 12.8512 11.5507 12.5 10.6667 12.5H5C4.11595 12.5 3.2681 12.8512 2.64298 13.4763C2.01786 14.1014 1.66667 14.9493 1.66667 15.8333V17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M7.83333 9.16667C9.67428 9.16667 11.1667 7.67428 11.1667 5.83333C11.1667 3.99238 9.67428 2.5 7.83333 2.5C5.99238 2.5 4.5 3.99238 4.5 5.83333C4.5 7.67428 5.99238 9.16667 7.83333 9.16667Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M18.3333 17.5V15.8333C18.3328 15.0948 18.0804 14.3773 17.6187 13.7936C17.157 13.2099 16.5126 12.793 15.7833 12.6083" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12.95 2.60834C13.6808 2.79192 14.3266 3.20892 14.7891 3.79359C15.2517 4.37827 15.5042 5.09736 15.5042 5.8375C15.5042 6.57765 15.2517 7.29674 14.7891 7.88141C14.3266 8.46609 13.6808 8.88309 12.95 9.06667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Χρήστες
                </a>
                <a href="{{ route('admin.posts', ['locale' => app()->getLocale()]) }}" class="nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <a href="{{ route('admin.comments', ['locale' => app()->getLocale()]) }}" class="nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <main class="dashboard-main">
            ...
            <div class="posts-section" style="margin-top: 30px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-top: 20px;">
                    <a href="{{ route('admin.users.create', ['locale' => app()->getLocale()]) }}" class="btn-primary" style="text-align: center;">
                    ...
                    <a href="{{ route('admin.users', ['locale' => app()->getLocale()]) }}" class="btn-primary" style="text-align: center; background: #6c757d;">
                        Διαχείριση Χρηστών
                    </a>
                    <a href="{{ route('admin.posts', ['locale' => app()->getLocale()]) }}" class="btn-primary" style="text-align: center; background: #28a745;">
                        Διαχείριση Άρθρων
                    </a>
                    <a href="{{ route('admin.comments', ['locale' => app()->getLocale()]) }}" class="btn-primary" style="text-align: center; background: #ffc107; color: #000;">
                        Έλεγχος Σχολίων
                    </a>
                </div>
            </div>
