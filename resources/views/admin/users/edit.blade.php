...
<head>
    ...
    <title>Επεξεργασία Χρήστη - Admin Panel</title>
    ...
    <div class="dashboard-layout">
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin.users', ['locale' => app()->getLocale()]) }}" class="nav-link active">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <main class="dashboard-main">
            <div class="form-container">
                <h2 style="margin-bottom: 20px;">Επεξεργασία: {{ $user->name }}</h2>
                
                <form action="{{ route('admin.users.update', ['locale' => app()->getLocale(), 'user' => $user->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            ...
                            <label for="is_active" style="margin: 0;">Ενεργός Χρήστης</label>
                        </div>
                        @error('is_active')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary">Ενημέρωση Χρήστη</button>
                        <a href="{{ route('admin.users', ['locale' => app()->getLocale()]) }}" class="btn-primary" style="background: #6c757d; text-decoration: none;">Ακύρωση</a>
                    </div>
                </form>
            </div>
        </main>
