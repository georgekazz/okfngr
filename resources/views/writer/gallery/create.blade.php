{{-- resources/views/writer/gallery/create.blade.php --}}
<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Νέα Ομάδα Φωτογραφιών - Writer Dashboard</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('writer.gallery.index', ['locale' => app()->getLocale()]) }}" class="nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <a href="{{ route('writer.gallery.create', ['locale' => app()->getLocale()]) }}" class="nav-link create-new active">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M10 4.16667V15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M4.16667 10H15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
        ...
        <main class="dashboard-main">
            ...
            <div class="page-header-row">
                <div>
                    <h2 class="page-title">Νέα Ομάδα Φωτογραφιών</h2>
                    <p class="header-subtitle">Προσθέστε φωτογραφίες για μια συγκεκριμένη ημερομηνία</p>
                </div>
            ...
            <form action="{{ route('writer.gallery.store', ['locale' => app()->getLocale()]) }}"
                ...
                <div class="form-card">
                    ...
                    <div class="form-row-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title"
                                   value="{{ old('title') }}"
                                   placeholder="π.χ. Open Data Day 2024"
                                   required
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  placeholder="Σύντομη περιγραφή της εκδήλωσης...">{{ old('description') }}</textarea>
                    </div>
                </div>

                <!-- Photos upload -->
                <div class="form-card">
                    <div class="form-card-title">Φωτογραφίες</div>
                    ...
                    <div class="dropzone" id="dropzone" onclick="document.getElementById('photoInput').click()">
                        ...
                        <p class="dropzone-text">Κάντε κλικ ή σύρετε φωτογραφίες εδώ</p>
                        <p class="dropzone-hint">JPG, PNG, WEBP · Μέχρι 5MB ανά αρχείο · Πολλαπλή επιλογή</p>
    ...
    Array.from(selectedFiles.files).forEach((file, i) => {
        ...
        reader.onload = e => {
            ...
            item.innerHTML = `
                ...
                <button type="button" class="preview-remove" onclick="removeFile(${i})" title="Αφαίρεση">
