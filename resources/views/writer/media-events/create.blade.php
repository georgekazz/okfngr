    ...
    <div class="dashboard-container">
        ...
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('writer.media-events.create', ['locale' => app()->getLocale()]) }}" class="nav-link create-new active">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M10 4.16667V15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M4.16667 10H15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
        ...
        <main class="dashboard-main">
            ...
            <div class="form-container">
                <form action="{{ route('writer.media-events.store', ['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="location" name="location" class="form-control" value="{{ old('location') }}" placeholder="π.χ. Αθήνα, Ελλάδα">
                            @error('location')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help" style="margin-bottom: 10px;">Προσθέστε συνδέσμους που σχετίζονται με την εκδήλωση (άρθρα, φωτογραφίες, βίντεο κ.λπ.)</div>
                        <div class="links-container" id="linksContainer">
                            <div class="link-item">
                                <input type="url" name="links[]" class="form-control" placeholder="https://example.com" value="{{ old('links.0') }}">
                            </div>
                        </div>
