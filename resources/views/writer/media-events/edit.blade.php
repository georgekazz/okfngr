    ...
    <div class="dashboard-container">
        ...
        <main class="dashboard-main">
            ...
            <div class="form-container">
                <form action="{{ route('writer.media-events.update', ['locale' => app()->getLocale(), 'mediaEvent' => $mediaEvent->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="title" class="required">Τίτλος Εκδήλωσης</label>
                        <input type="text" id="title" name="title" class="form-control" value="{{ old('title', $mediaEvent->title) }}" required>
                        @error('title')
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" id="event_date" name="event_date" class="form-control" value="{{ old('event_date', $mediaEvent->event_date->format('Y-m-d')) }}" required>
                            @error('event_date')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="location" name="location" class="form-control" value="{{ old('location', $mediaEvent->location) }}" placeholder="π.χ. Αθήνα, Ελλάδα">
                            @error('location')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" required>{{ old('description', $mediaEvent->description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="image" name="image" class="form-control" accept="image/*" onchange="previewImage(event)" style="margin-top: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="links-container" id="linksContainer">
                            @if($mediaEvent->links && count($mediaEvent->links) > 0)
                                ...
                                <div class="link-item">
                                    <input type="url" name="links[]" class="form-control" placeholder="https://example.com" value="{{ old('links.' . $index, $link) }}">
                                    @if($index > 0)
