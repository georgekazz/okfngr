    ...
    <div class="dashboard-container">
        ...
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('writer.media-events.index', ['locale' => app()->getLocale()]) }}" class="nav-link active">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <path d="M6.66667 2.5V5.83333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <main class="dashboard-main">
            <div class="dashboard-header">
                ...
                <a href="{{ route('writer.media-events.create', ['locale' => app()->getLocale()]) }}" class="btn-primary">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M10 4.16667V15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M4.16667 10H15.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <div class="events-grid">
                ...
                <div class="event-card {{ $event->status }}">
                    ...
                    <div class="event-meta">
                        <div class="event-meta-item">
                            <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5">
                                <path d="M17.5 5.83333H2.5V15.8333C2.5 16.2754 2.67559 16.6993 2.98816 17.0118C3.30072 17.3244 3.72464 17.5 4.16667 17.5H15.8333C16.2754 17.5 16.6993 17.3244 17.0118 17.0118C17.3244 16.6993 17.5 16.2754 17.5 15.8333V5.83333Z" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div class="event-meta-item">
                            <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5">
                                ...
                                <path d="M10 17.5C13.3333 14.1667 16.6667 11.1548 16.6667 8.33333C16.6667 4.65143 13.6819 1.66667 10 1.66667C6.3181 1.66667 3.33333 4.65143 3.33333 8.33333C3.33333 11.1548 6.66667 14.1667 10 17.5Z" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            {{ $event->location }}
                        </div>
                        @endif
                    ...
                    <div class="event-actions">
                        <a href="{{ route('writer.media-events.edit', ['locale' => app()->getLocale(), 'mediaEvent' => $event->id]) }}" class="btn-edit">
                        ...
                        <form action="{{ route('writer.media-events.destroy', ['locale' => app()->getLocale(), 'mediaEvent' => $event->id]) }}" method="POST" style="display: inline;" onsubmit="return confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την εκδήλωση;');">
                            @csrf
                            @method('DELETE')
            ...
            <div class="empty-state">
                <svg viewBox="0 0 20 20" fill="none" stroke="currentColor">
                    <path d="M17.5 5.83333H2.5V15.8333C2.5 16.2754 2.67559 16.6993 2.98816 17.0118C3.30072 17.3244 3.72464 17.5 4.16667 17.5H15.8333C16.2754 17.5 16.6993 17.3244 17.0118 17.0118C17.3244 16.6993 17.5 16.2754 17.5 15.8333V5.83333Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
