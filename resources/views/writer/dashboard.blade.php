                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ route('writer.posts.edit', ['locale' => app()->getLocale(), 'post' => $post->id]) }}"
                                                    ...
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                        <path
                                                            ...
                                                            stroke-linejoin="round" />
                                                        <path
                                                            d="M13.875 1.87498C14.1734 1.57661 14.5778 1.40918 15 1.40918C15.4222 1.40918 15.8266 1.57661 16.125 1.87498C16.4234 2.17336 16.5908 2.57782 16.5908 2.99998C16.5908 3.42215 16.4234 3.82661 16.125 4.12498L9 11.25L6 12L6.75 9L13.875 1.87498Z"
                                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </a>
                                                @if($post->status === 'published')
                                                    <a href="{{ url('/el/posts/' . $post->slug) }}" class="btn-icon" target="_blank"
                                                        title="Προβολή">
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                            <path
                                                ...
                                                @endif
                                                <form action="{{ url('/el/writer/posts/' . $post->id) }}" method="POST"
                                                    style="display: inline;"
                                                    onsubmit="return confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το άρθρο;')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn-icon btn-delete" title="Διαγραφή">
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                            <path d="M2.25 4.5H3.75H15.75" stroke="currentColor"
                ...
                @else
                    <div class="empty-state">
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                            <path
                                d="M37.3333 10.6667H16C14.5855 10.6667 13.2289 11.2286 12.2287 12.2288C11.2286 13.229 10.6667 14.5855 10.6667 16V48C10.6667 49.4145 11.2286 50.7711 12.2287 51.7713C13.2289 52.7714 14.5855 53.3333 16 53.3333H48C49.4145 53.3333 50.7711 52.7714 51.7713 51.7713C52.7714 50.7711 53.3333 49.4145 53.3333 48V26.6667L37.3333 10.6667Z"
                                stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M37.3333 10.6667V26.6667H53.3333" stroke="currentColor" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
