...
return [
    ...
    'hero' => [
        'badge' => 'Our Team',
        'title' => 'Meet Our Team',
        'subtitle' => 'A team of dedicated professionals working to promote open knowledge and open data in Greece.',
    ],

    'intro' => [
        'title' => 'The People Behind the Vision',
        'text' => 'Our team consists of people passionate about openness, technology, and social change. From developers and researchers to activists and educators, we all share the same mission.',
    ],
    ...
    'volunteer_members' => [
        [
            ...
            'role' => 'Volunteer',
            'bio' => 'Christina Karypidou is a graduate of the Department of Journalism and Mass Media at Aristotle University of Thessaloniki. In the same Department she completed her postgraduate studies, with direction "Journalism and New Media". In her thesis she researched how users and news websites utilize social networking tools. In her dissertation she studies data journalism in Greece. Professionally, she has been involved with radio and has written articles on the internet. Also, she has been employed in administrative positions in public services, private companies and as a freelancer. She has been active in self-funded and co-funded programs, has participated in scientific conferences and NGO projects.',
        ...
        [
            'name' => 'Despoina Mantziari',
            'role' => 'Volunteer',
            'bio' => 'Despoina Mantziari is a graduate of the Department of Journalism and Mass Media at Aristotle University of Thessaloniki, where she continues her postgraduate studies, specializing in "Journalism and New Media". Her involvement with the "world" of Open Data began through her undergraduate thesis at the Laboratory of Informatics Applications in Mass Media of the Department of Journalism and Mass Media, on the subject of Data Journalism. In the context of her postgraduate studies she deals with the fields of Content Verification and Fake News. Professionally, she has worked in the field of sports journalism, while she also worked as an Account Manager at a press clipping company. She participates in research teams and laboratories of the Department of Journalism. Her interests are literature, photography and theater.',
        ...
        [
            'name' => 'Maria S. Schoina',
            'role' => 'Volunteer',
            'bio' => 'She is a Civil Engineer graduate from Aristotle University of Thessaloniki. The first years after obtaining her diploma she dealt with static studies and issuance of building permits collaborating with a technical-construction company. Since 2000 she has been employed at the Urenio Research Unit of AUTH as a member of the Management and Implementation Unit of National and European research/development programs in the fields of Innovation, Regional Development, Business Intelligence, Technology Management, and Smart Cities. Since 2013 she participates voluntarily in the actions of Open Knowledge Foundation Greece (OKF Gr) and the Women Managers and Entrepreneurs Development Section (TOGME) of the Hellenic Management Association (EEDE), Macedonia branch. Her involvement with OKFN GR includes among other things the coordination and organization of events and actions while at the same time she was one of the main contributors to the "2014 Open Data Census report for the Greek Cities".',
        ...
        [
            'name' => 'Anthi Baliou',
            'role' => 'Volunteer',
            'bio' => 'Anthi Baliou is a PhD candidate in the Department of Journalism and Mass Media at Aristotle University of Thessaloniki. Since 2000 she has been working as a librarian at the Library of the University of Macedonia. She holds a master\'s degree in "Cultural Unit Management" at the Hellenic Open University. She has participated in various research programs as Researcher and as Project Manager (EUFactCheck, JRP, Refugees Fact-checking, DCN Global) in the field of news verification, misinformation and media education. Also, she teaches as an Academic Fellow in the Department of Library Science, Archival Science and Information Systems, International Hellenic University. Her research interests include: Information, News and Media Education, Misinformation, Propaganda and Fake News, Social influence of media and social media.',
    ...
    'join' => [
        'title' => 'Join Us',
        'text' => 'We are always looking for talented and passionate people to join our team. If you believe in open knowledge and want to make a difference, we would love to hear from you.',
        'button' => 'Contact Us',
    ],
];
