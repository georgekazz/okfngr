...
return [
    ...
    'publications' => [
        [
            ...
            'year' => '2016',
            'description' => [
                'Η απογραφή των ανοικτών δεδομένων των ελληνικών πόλεων από το ελληνικό παράρτημα του Ιδρύματος Ανοικτής Γνώσης υλοποιήθηκε στο πλαίσιο των δράσεων του Ιδρύματος για την ανάδειξη της σημασίας των ανοικτών δεδομένων, αλλά και των δεσμεύσεών του, στο πλαίσιο του 3ου Εθνικού Σχεδίου Δράσης για την <a href="https://www.opengovpartnership.org/documents/3-2016-2018" target="_blank" rel="noopener" style="color:#00D1FF;font-weight:600;">Ανοικτή Διακυβέρνηση 2016-2018</a>. Μέσα από την ετήσια απογραφή, επιτυγχάνονται δύο στόχοι:',
        ...
        [
            ...
            'year' => '2014',
            'description' => [
                'Η <a href="http://gr-city.census.okfn.org/" target="_blank" rel="noopener" style="color:#00D1FF;font-weight:600;">απογραφή των ανοικτών δεδομένων</a> των ελληνικών πόλεων από το Ελληνικό παράρτημα του Ιδρύματος Ανοικτής Γνώσης υλοποιήθηκε στο πλαίσιο των δράσεων του Ιδρύματος για την ανάδειξη της σημασίας των ανοικτών δεδομένων. Στόχος της απογραφής είναι να εντοπίσει και να παρουσιάσει σε παγκόσμιο επίπεδο τη θέση των ελληνικών πόλεων σε σχέση με το πώς διαχειρίζονται τα δεδομένα τους.',
